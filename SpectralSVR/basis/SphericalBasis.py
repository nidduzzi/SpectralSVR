...
#             k = SphericalBasis.waveNumber(num_modes).T
#             dim_basis_shape = [1 for i in range(ndims + 1)]
#             dim_basis_shape[0] = x.shape[0]
#             dim_basis_shape[dim + 1] = num_modes
...
#
#         F_flattened = SphericalBasis._raw_transform(f_flatened, func=func)
...
#             f = f * (1 + 0j)
#         if ndims == 2:
#             F = SphericalBasis._raw_transform(f, "forward")
#         elif ndims > 2:
#             # perform 1d transform over every dimension
#             F = SphericalBasis._ndim_transform(f, dim=1, func="forward")
#             for cdim in range(2, ndims):
#                 F = SphericalBasis._ndim_transform(F, dim=cdim, func="forward")
#
#         return F
#
#     @staticmethod
...
#             coeff = coeff * (1 + 0j)
#         if ndims == 2:
#             X = SphericalBasis._raw_transform(coeff, func="inverse")
#         elif ndims > 2:
#             # perform 1d transform over every dimension
#             X = SphericalBasis._ndim_transform(coeff, dim=1, func="inverse")
#             for cdim in range(2, ndims):
#                 X = SphericalBasis._ndim_transform(X, dim=cdim, func="inverse")
#
#         return X
